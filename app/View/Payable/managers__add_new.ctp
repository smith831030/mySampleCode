				...
				<div class="col-md-6 form-group table-responsive">
					...
					echo '<p><label>GST</label> <span id="span_gst"></span></p>';
					echo '<p><label>Total</label> <span id="span_total"></span></p>';
					echo $this->Form->input('ip_comment', array('type'=>'textarea', 'label'=>'Comment', 'class'=>'form-control'));
					
					echo '<br />';
					echo $this->Form->button('Create', array('type'=>'submit', 'class'=>'btn btn-lg btn-primary btn-block'));
